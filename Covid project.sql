...
---- Selecting relevant data to my project
...
Select Location, date, Population, total_cases,  ((cast(Total_deaths as int))/(cast(population as int)))*100 as PercentPopulationInfected
From PortfolioProject..CovidDeaths
...
-- Maximum amount of death in Nigeria
Select Location, max(cast(Total_deaths as int)) as TotalDeathCount
From PortfolioProject..CovidDeaths
